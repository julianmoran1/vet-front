...
const Paciente = ({ paciente }) => {
    ...
    const formatearFecha = (fecha) => {
        ...
        return Intl.DateTimeFormat("es", { dateStyle: "long" }).format(nuevaFecha)
    }
    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-md">
            ...
            <p className="font-bold uppercase text-indigo-600 my-2">Correo: <span className="font-normal normal-case text-black">{email}</span></p>

            <p className="font-bold uppercase text-indigo-600 my-2">Fecha de alta: <span className="font-normal normal-case text-black">{formatearFecha(fecha)}</span></p>

            <p className="font-bold uppercase text-indigo-600 my-2">síntomas: <span className="font-normal normal-case text-black">{sintomas}</span></p>
